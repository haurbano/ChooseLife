 ...
 */
public class MesTresFragment extends TitleFragment {

    public static final String TITLE = "Noviembre";

    public MesTresFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_mes_tres, container, false);
    }
